...
public class Dictionary {
  ...
  public static Dictionary fromFile(String dictionaryPath) throws IOException {
    ...
    Stream<String> stream = Files.lines(Paths.get(dictionaryPath));
    ...
    System.out.println("Read " + counter.get() + " dictionary words in " + (System.currentTimeMillis() - started) + " millis");

    if (!skippedWords.isEmpty()) {
      System.out.println("Skipped " + skippedWords.size() + " incorrect dictionary words");
